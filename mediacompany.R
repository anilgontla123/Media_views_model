...
ggplot(media, aes(day, Views_show)) + geom_line(aes(colour = "blue" )) + scale_x_continuous(name = "days", breaks = seq(0,84,7), limits = c(0,84)) + scale_y_continuous(name = "Views_show", breaks = seq(0,800000,100000),limits = c(0,800000))
